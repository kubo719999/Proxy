...
setup_cron_rotation() {
    echo "Setting up cron (10 MINUTE rotation)..."
    ...
    echo "Cron configured: EVERY 10 MINUTES"
}

echo "================================================================"
echo "  3PROXY - 50 PORTS - 10 MINUTE ROTATION (PRODUCTION)          "
echo "================================================================"
...
echo ""
echo "================================================================"
echo "INSTALLATION COMPLETED - PRODUCTION MODE"
echo "================================================================"
echo ""
echo "Configuration:"
...
echo ""
echo "Quick checks:"
echo "  Status: echo \"P:\$(wc -l < /home/bkns/data.txt) I:\$(ip -6 addr show eth0 | grep -c 'inet6.*scope global')\""
echo "  Logs: tail -f /home/bkns/rotate.log"
