...
FIRST_PORT=22000#!/bin/bash
# ==========================================================
# AUTO CREATE + ROTATE IPV6 PROXY (FINAL FIXED VERSION)
# KEEP BASE IPV6 - SAFE ROTATE
# ==========================================================
...
# ===== AUTO DETECT OR CREATE BASE IPV6 =====
...
if [ -z "$BASE_IPV6" ]; then
    ...
    if [ -z "$PREFIX" ]; then
        echo "[$(date)] ERROR: NO IPV6 /64 ROUTE FOUND"
        exit 1
    fi
...
echo "[$(date)] TOTAL IPV6: $COUNT (BASE + PROXY)"
...
echo "=========================================="
echo "INSTALL DONE - FINAL VERSION"
