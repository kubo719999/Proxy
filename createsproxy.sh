...
log_msg "WARNING: $BEFORE IPs - cleanup"
...
if [ "$IP_COUNT" -gt 100 ]; then
    echo "[$(date '+%Y-%m-%d %H:%M:%S')] Too many IPs ($IP_COUNT)" >> /home/bkns/monitor.log
...
setup_cron_rotation() {
    echo "Setting up cron (1 MINUTE rotation for testing)..."
    
    crontab -r 2>/dev/null
    
    (
        echo "* * * * * /home/bkns/rotate_ipv6.sh >> /home/bkns/rotate.log 2>&1"
    ...
    echo "✅ Cron configured: EVERY 1 MINUTE (for testing)"
}

echo "================================================================"
echo "  3PROXY - 50 PORTS - 1 MINUTE ROTATION (TEST MODE)            "
echo "================================================================"
...
echo ""
echo "================================================================"
echo "TEST MODE - ROTATION EVERY 1 MINUTE"
echo "================================================================"
echo ""
echo "Config:"
echo "   Ports: 50 (10000-10049)"
echo "   Rotation: EVERY 1 MINUTE (for testing)"
echo ""
echo "Monitor for 5 minutes:"
echo "   tail -f /home/bkns/rotate.log"
echo ""
echo "After testing OK, change to 10 minutes:"
echo "   crontab -e"
echo "   Change: * * * * *"
echo "   To:     */10 * * * *"
echo ""
echo "Or run this command:"
echo '   (crontab -l | sed "s/^\* \* \* \* \*/\*\/10 \* \* \* \*/") | crontab -'
echo ""
echo "================================================================"
